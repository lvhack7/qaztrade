            ...
            <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mb-6'>
                    ...
                    <div className='flex flex-col space-y-2'>
                        <p className='text-button text-4xl xl:text-5xl font-medium'>$ 
                            <span className='text-7xl xl:text-[5rem]'>
                                <CountUp start={focus ? 100000 : null} end={328890} duration={3} redraw={true}>
                                    {({ countUpRef }) => (
                ...
                <div className='bg-lightGray p-4 lg:p-6 flex items-center justify-center rounded-[20px]'>
                    <div className='flex flex-col space-y-2'>
                        <p className='text-button text-4xl xl:text-5xl font-medium'>$ 
                            <span className='text-7xl xl:text-[5rem]'>
                                <CountUp start={focus ? 100000 : null} end={210278.3} seperator=',' decimals={1} duration={3.5} redraw={true}>
                                    {({ countUpRef }) => (
                                        <VisibilitySensor onChange={(isVisible) => {
                                            if (isVisible) { setFocus(true); }
                                        }}>
                ...
                <div className='bg-lightGray p-4 lg:p-6 flex items-center justify-center rounded-[20px]'>
                    <div className='flex flex-col space-y-2'>
                        <p className='text-button text-4xl xl:text-5xl font-medium'>$ 
                            <span className='text-7xl xl:text-[5rem]'>
                                <CountUp start={focus ? 100000 : null} end={118611.7} duration={4} seperator=',' decimals={1} redraw={true}>
                                    {({ countUpRef }) => (
                                        <VisibilitySensor onChange={(isVisible) => {
                                            if (isVisible) { setFocus(true); }
                                        }}>
